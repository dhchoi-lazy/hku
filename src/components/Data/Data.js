...
export default function Data() {
  ...
  return (
    <section id="data" ref={dataRef}>
      <GridContainer>
        <h2 className="text-2xl">Data Description and Implementation</h2>
        <GridHighlight>
        ...
        <GridHighlight>
          <h3 className="text-2xl font-bold">
            How many people became Yangban through the Gwageo system?
          </h3>
          <Bangmok />
        </GridHighlight>

        <GridHighlight>
          <h3 className="text-2xl font-bold">Where they come from?</h3>
          <Cartogram />
        </GridHighlight>

        <GridNormal>
          <h3 className="text-2xl font-bold">How long they did live?</h3>
          <Age />
        </GridNormal>
      </GridContainer>
    </section>
